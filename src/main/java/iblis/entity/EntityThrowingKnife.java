...
public class EntityThrowingKnife extends EntityArrow {
	...
	public EntityThrowingKnife(World worldIn, EntityPlayer playerIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	...
	protected ItemStack getArrowStack() {
		return new ItemStack(IblisItems.IRON_THROWING_KNIFE);
	}
	...
	protected void onHit(RayTraceResult result) {
		if (result.entityHit != null) {
			result.entityHit.attackEntityFrom(DamageSource.causeThrownDamage(this, this.shootingEntity),
